...
function RecordVideo({ model_video }) {
    ...
    useEffect(() => {
        ...
        if (status) {
            video.play();
            detectPose().then(() => {
                console.log("posedetection complete")
            });
        }
        else {
            video.pause();
    ...
    return (
        <div>
            ...
            <div>
                <video style={{ margin: '10px' }} id="videoNoShow" playsInline ref={videoRef} />
